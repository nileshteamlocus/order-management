    ...
    <div class="container-fluid page-body-wrapper">
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="card">
                    <div class="card-body">
                        <button onclick="<!-- 1printDiv('printMe') -->" type="button" class="btn btn-primary"><i class="mdi mdi-printer mr-1"></i>Print Aggregate/Picking Order(s)</button>
